    ...
    <div class="row">
        ...
        <ul class="pagination">
            ...
            <li class="page-item active">
                <a class="page-link" href="product.php">1 <span class="sr-only">(current)</span></a>
            </li>
            <li class="page-item"><a class="page-link" href="product2.php">2</a></li>
            <li class="page-item">
            <a class="page-link" href="product2.php">Next</a>
            </li>
        </ul>
        </nav>
    </div>
